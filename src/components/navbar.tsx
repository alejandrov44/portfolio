    ...
    <>
      <nav className={`navbar ${isScrolled ? "scrolled" : ""}`}>
        <div className="navbar-container">
          <Link className="navbar-logo" href="/">
            <Image alt="Page Logo" priority={true} src={pageLogo} />
          </Link>
          ...
          <div className="github-stars-button">
            <a className="github-stars-link" href={`https://github.com/${repo}`} rel="noopener noreferrer" target="_blank">
              <svg aria-hidden="true" fill="currentColor" height="1.5em" viewBox="0 0 16 16" width="1.5em">
      ...
      <div className={`sidebar ${isSidebarOpen ? "open" : ""}`}>
        <div className="sidebar-logo">
          <Image alt="Page Logo" src={pageLogo} />
        </div>
        <ul>
          <li>
